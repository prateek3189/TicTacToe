...
var TicTacToe = React.createClass({
    propTypes: {
        ...
        onEnterPlayerName: React.PropTypes.func
    },
    ...
    render: function () {
        ...
        return (
            <div>
                <h1>Tic Tac Toe</h1>
                <h3>Welcome <span id="player"></span></h3>
                <table>
                    <tbody>
                        {rows}
                    </tbody>
                ...
                <div className="popup" id="popup">
                    <div className="content">
                        <div id="popupContent" className="gameResult">You Won...</div>
                        <button id="restartGame" className="restartGame" onClick={this._restartGame}>Restart Game</button>
                    </div>
                    <div className="fade"></div>
                </div>

                <div className="popup" id="popup_name">
                    <div className="content">
                        <h1>Enter your name:</h1>
                        <div><input type="text" id="player_name" className="player_name" name="player_name" /></div>
                        <div>
                            <button id="enterName" className="enterName" onClick={this._enterPlayerName}>Start Game</button>
                        </div>
                    </div>
                    <div className="fade"></div>
                </div>
    ...
    _enterPlayerName: function () {
        if (typeof this.props.onEnterPlayerName === 'function') {
            this.props.onEnterPlayerName();
        }
    },
...
var App = React.createClass({
    ...
    render: function () {
        return (this.state.data
            ? <TicTacToe
                ...
                onEnterPlayerName={this._onEnterPlayerName}
    ...
    _onEnterPlayerName: function() {
        var playerName = document.getElementById('player_name').value;
        if(playerName === '') {
            alert('Please enter your name');
        } else {
            this.socket.emit('game:enter:player:name', playerName);
    ...
    _bindEvents: function() {
        ...
        this.socket.on('game:enter:name', function () {
